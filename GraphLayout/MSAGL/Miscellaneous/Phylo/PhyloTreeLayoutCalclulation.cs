...
namespace Microsoft.Msagl.Prototype.Phylo {
  internal class PhyloTreeLayoutCalclulation : AlgorithmBase {
    ...
    void CalcAnchorsForOriginalNode(int i) {
      ...
      anchors[i] = new Anchor(leftAnchor, rightAnchor, topAnchor, bottomAnchor, this.intGraph.Nodes[i], LayoutSettings.LabelCornersPreserveCoefficient) { Padding = this.intGraph.Nodes[i].Padding };
#if TEST_MSAGL
