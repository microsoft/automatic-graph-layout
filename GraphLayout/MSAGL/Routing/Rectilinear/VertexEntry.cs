...
namespace Microsoft.Msagl.Routing.Rectilinear {
    public class VertexEntry {
        ...
        public VertexEntry(VisibilityVertexRectilinear vertex, VertexEntry prevEntry, double length, int numberOfBends, double cost) {
            this.Vertex = vertex;
 ...
 // TEST_MSAGL
        ...
        /// </summary>
        public VisibilityVertexRectilinear PreviousVertex { get { return (this.PreviousEntry == null) ? null : this.PreviousEntry.Vertex; } }
        ...
        /// </summary>
        public VertexEntry PreviousEntry { get; private set; }
