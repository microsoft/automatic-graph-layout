...
namespace TestGraphmaps.Annotations
{
  /// <summary>
  ...
  public sealed class BaseTypeRequiredAttribute : Attribute
  {
    ...
    [NotNull] public Type BaseType { get;  set; }
  }
  ...
  public sealed class MeansImplicitUseAttribute : Attribute
  {
    ...
    [UsedImplicitly] public ImplicitUseKindFlags UseKindFlags { get;  set; }
    [UsedImplicitly] public ImplicitUseTargetFlags TargetFlags { get;  set; }
  }
  ...
  /// </summary>
  /// <example><code>
  /// [Pure]  int Multiply(int x, int y) { return x * y; }
  /// public void Foo() {
  ///   const int a = 2, b = 2;
  ...
  public class PathReferenceAttribute : Attribute
  {
    ...
    [NotNull] public string BasePath { get;  set; }
  }
  ...
  public sealed class AspMvcActionAttribute : Attribute
  {
    ...
    [NotNull] public string AnonymousProperty { get;  set; }
  }
