...
define(["require", "exports"], function (require, exports) {
    ...
    function callbackCGraph(ggraph) {
        var updateCanvas = $("#updateCanvas")[0].checked;
        var updateIDD = $("#updateCanvas")[0].checked;
    ...
    function callbackSVGGraph(ggraph) {
        var updateSVG = $("#updateSVG")[0].checked;
        var updateIDDSVG = $("#updateIDDSVG")[0].checked;
    ...
    function customDrawLabelCanvas(context, label) {
        if (label.content != "*")
            return false;
        context.beginPath();
    ...
    function customDrawLabelSVG(svg, parent, label) {
        if (label.content != "*")
            return false;
    ...
    function performUpdate() {
        var updateCanvas = $("#updateCanvas")[0].checked;
        var updateIDD = $("#updateIDD")[0].checked;
        var updateSVG = $("#updateSVG")[0].checked;
        var updateIDDSVG = $("#updateIDDSVG")[0].checked;
        ...
        if (updateCanvas || updateIDD) {
            ...
            ggraphContext.beginLayoutGraph(function () {
                callbackCGraph(ggraphContext);
            });
    ...
    exports.onUpdateClicked = onUpdateClicked;
    ...
    var g = null;
    var fc = null;
    function onUpdateDOMTextClicked() {
        updateDOMText();
    }
    exports.onUpdateDOMTextClicked = onUpdateDOMTextClicked;
});
