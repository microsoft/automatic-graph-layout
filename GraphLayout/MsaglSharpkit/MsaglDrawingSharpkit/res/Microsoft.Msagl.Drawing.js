...
var Microsoft$Msagl$Drawing$Utils = {
    ...
    staticDefinition: {
        ...
        ConcatTwoWithDelimeter: function (delimeter, s0, s1){
            if (System.String.IsNullOrEmpty(s0))
                return s1;
            if (System.String.IsNullOrEmpty(s0))
                return s0;
...
var Microsoft$Msagl$Drawing$Graph = {
    ...
    staticDefinition: {
        ...
        WriteNodeCollection: function (sw, nodeLabels){
            var i = 0;
            sw.Write$$String(" ");
            var $it20 = nodeLabels.GetEnumerator();
            while ($it20.MoveNext()){
                var s = $it20.get_Current();
                sw.Write$$String(s);
                sw.Write$$String(" ");
                i = (i + 1) % 6;
                if (i == 0)
    ...
    definition: {
        ...
        WriteNodes: function (sw){
            ...
            var $it21 = this.nodeMap.get_Values().GetEnumerator();
            while ($it21.MoveNext()){
        ...
        WriteEdges: function (tw){
            var $it22 = this.get_Edges().GetEnumerator();
            while ($it22.MoveNext()){
                var edge = $it22.get_Current();
        ...
        AddNode$$String: function (nodeId){
            ...
            if (this.get_RootSubgraph() != null && this.get_RootSubgraph().get_IsUpdated()){
                ...
                var $it23 = this.get_RootSubgraph().AllSubgraphsDepthFirst().GetEnumerator();
                while ($it23.MoveNext()){
                    var sg = $it23.get_Current();
        ...
        EdgeById: function (edgeId){
            if (this.idToEdges == null || this.idToEdges.get_Count() == 0){
                var $it24 = this.get_Edges().GetEnumerator();
                while ($it24.MoveNext()){
        ...
        RemoveNode: function (node){
            ...
            var $it25 = node.get_InEdges().GetEnumerator();
            while ($it25.MoveNext()){
                var e = $it25.get_Current();
                delendi.Add(e);
            }
            var $it26 = node.get_OutEdges().GetEnumerator();
            while ($it26.MoveNext()){
                var e = $it26.get_Current();
                delendi.Add(e);
            }
            var $it27 = node.get_SelfEdges().GetEnumerator();
            while ($it27.MoveNext()){
                var e = $it27.get_Current();
                delendi.Add(e);
            }
            var $it28 = delendi.GetEnumerator();
            while ($it28.MoveNext()){
                var e = $it28.get_Current();
                this.RemoveEdge(e);
            }
        ...
        get_Edges: function (){
            ...
            if (this.get_RootSubgraph() != null){
                var $it29 = this.get_RootSubgraph().AllSubgraphsWidthFirstExcludingSelf().GetEnumerator();
                while ($it29.MoveNext()){
                    var subgraph = $it29.get_Current();
                    var $it30 = subgraph.get_OutEdges().GetEnumerator();
                    while ($it30.MoveNext()){
                        var e = $it30.get_Current();
                        $yield.push(e);
                    }
                    var $it31 = subgraph.get_SelfEdges().GetEnumerator();
                    while ($it31.MoveNext()){
            ...
            var $it32 = this.get_Nodes().GetEnumerator();
            while ($it32.MoveNext()){
                var node = $it32.get_Current();
                var $it33 = node.get_OutEdges().GetEnumerator();
                while ($it33.MoveNext()){
                    var e = $it33.get_Current();
                    $yield.push(e);
                }
                var $it34 = node.get_SelfEdges().GetEnumerator();
                while ($it34.MoveNext()){
                    var e = $it34.get_Current();
                    $yield.push(e);
                }
            }
            return $yield;
...
var Microsoft$Msagl$Drawing$GraphReader = {
    ...
    definition: {
        ...
        FleshOutSubgraphs: function (){
            var $it35 = this.subgraphTable.get_Values().GetEnumerator();
            while ($it35.MoveNext()){
                var subgraphTemlate = $it35.get_Current();
                var subgraph = subgraphTemlate.Subgraph;
                var $it36 = subgraphTemlate.SubgraphIdList.GetEnumerator();
                while ($it36.MoveNext()){
                    var id = $it36.get_Current();
                    subgraph.AddSubgraph(this.subgraphTable.get_Item$$TKey(id).Subgraph);
                }
                var $it37 = subgraphTemlate.NodeIdList.GetEnumerator();
                while ($it37.MoveNext()){
                    var id = $it37.get_Current();
            ...
            var $it38 = System.Linq.Enumerable.Select$2$$IEnumerable$1$$Func$2(Microsoft.Msagl.Drawing.SubgraphTemplate.ctor, Microsoft.Msagl.Drawing.Subgraph.ctor, this.subgraphTable.get_Values(), $CreateAnonymousDelegate(this, function (c){
                return c.Subgraph;
            })).GetEnumerator();
            while ($it38.MoveNext()){
            ...
            if (rootSubgraphSet.get_Count() == 1)
                ...
                var $it39 = rootSubgraphSet.GetEnumerator();
                while ($it39.MoveNext()){
                    var subgraph = $it39.get_Current();
                    this.graph.get_RootSubgraph().AddSubgraph(subgraph);
                }
            }
        },
        ...
        ReadLabel: function (parent){
            ...
            if (hasLabel){
                ...
                var label = (function (){
                    ...
                    $v8.set_FontStyle(this.TokenIs(Microsoft.Msagl.Drawing.Tokens.FontStyle) ? Cast(this.ReadIntElement(Microsoft.Msagl.Drawing.Tokens.FontStyle), Microsoft.Msagl.Drawing.FontStyle.ctor) : Microsoft.Msagl.Drawing.FontStyle.Regular);
        ...
        BindTheGraphs: function (drawingGraph, geomGraph, settings){
            ...
            var $it40 = drawingGraph.get_NodeMap().get_Values().GetEnumerator();
            while ($it40.MoveNext()){
                var dn = $it40.get_Current();
            ...
            var $it41 = drawingGraph.get_RootSubgraph().AllSubgraphsDepthFirst().GetEnumerator();
            while ($it41.MoveNext()){
                var subgraph = $it41.get_Current();
...
var Microsoft$Msagl$Drawing$GraphWriter = {
    ...
    definition: {
        ...
        WriteSubgraphs: function (){
            ...
            var $it42 = this.graph.get_RootSubgraph().AllSubgraphsDepthFirstExcludingSelf().GetEnumerator();
            while ($it42.MoveNext()){
        ...
        BuildGeomNodesAndClustersToIdsDictionary: function (){
            ...
            var $it43 = nodesAndClusters.GetEnumerator();
            while ($it43.MoveNext()){
                var node = $it43.get_Current();
        ...
        WriteEdges: function (){
            ...
            var $it44 = this.graph.get_Edges().GetEnumerator();
            while ($it44.MoveNext()){
        ...
        WriteNodes: function (){
            ...
            var $it45 = this.graph.get_Nodes().GetEnumerator();
            while ($it45.MoveNext()){
                var node = $it45.get_Current();
                this.WriteNode(node);
            }
            this.WriteEndElement();
        },
        ...
        WriteStyles: function (styles){
            ...
            var $it46 = styles.GetEnumerator();
            while ($it46.MoveNext()){
                var s = $it46.get_Current();
...
var Microsoft$Msagl$Drawing$GeometryGraphEditor = {
    ...
    staticDefinition: {
        ...
        CreateBaseSegmentForDraggingEdgeWithTarget: function (delta, edge, edgeRestoreData, offsets){
            var offset;
            var seg;
            var a = edgeRestoreData.get_UnderlyingPolyline().get_HeadSite().get_Point();
            var b = Microsoft.Msagl.Core.Geometry.Point.op_Addition(edgeRestoreData.get_UnderlyingPolyline().get_LastSite().get_Point(), delta);
            if ((function (){
                var $1 = {
                    Value: offset
                };
                var $res = offsets.TryGetValue(edge, $1);
                offset = $1.Value;
                return $res;
            })() && offset != 0){
                var ab = Microsoft.Msagl.Core.Geometry.Point.op_Subtraction(b, a);
                var abOrtog = Microsoft.Msagl.Core.Geometry.Point.op_Multiply$$Point$$Double(ab.Normalize().Rotate(-1.5707963267949), offset);
                seg = (function (){
                    var $1 = {
                        Value: a
                    };
                    ...
                    var $res = Microsoft.Msagl.Drawing.GeometryGraphEditor.CreateBaseSegOnSourceTargetAndOrth($1, $2, $3);
                    a = $1.Value;
                    b = $2.Value;
                    abOrtog = $3.Value;
                    return $res;
                ...
                seg = new Microsoft.Msagl.Core.Geometry.Curves.LineSegment.ctor$$Point$$Point(a, b);
            return seg;
        },
        CreateBaseSegOnSourceTargetAndOrth: function (a, b, abOrtog){
            var seg = new Microsoft.Msagl.Core.Geometry.Curves.CubicBezierSegment.ctor(a.Value, Microsoft.Msagl.Core.Geometry.Point.op_Addition(Microsoft.Msagl.Core.Geometry.Point.op_Addition(Microsoft.Msagl.Core.Geometry.Point.op_Division$$Point$$Double(Microsoft.Msagl.Core.Geometry.Point.op_Multiply$$Point$$Double(a.Value, 3), 4), Microsoft.Msagl.Core.Geometry.Point.op_Division$$Point$$Double(b.Value, 4)), abOrtog.Value), Microsoft.Msagl.Core.Geometry.Point.op_Addition(Microsoft.Msagl.Core.Geometry.Point.op_Addition(Microsoft.Msagl.Core.Geometry.Point.op_Division$$Point$$Double(Microsoft.Msagl.Core.Geometry.Point.op_Multiply$$Point$$Double(b.Value, 3), 4), Microsoft.Msagl.Core.Geometry.Point.op_Division$$Point$$Double(a.Value, 4)), abOrtog.Value), b.Value);
            return seg;
        },
        CreateBaseSegmentForDraggingEdgeWithSource: function (delta, edge, edgeRestoreData, offsets){
            var offset;
            var seg;
            var a = Microsoft.Msagl.Core.Geometry.Point.op_Addition(edgeRestoreData.get_UnderlyingPolyline().get_HeadSite().get_Point(), delta);
            var b = edgeRestoreData.get_UnderlyingPolyline().get_LastSite().get_Point();
            if ((function (){
                var $1 = {
                    Value: offset
                };
        ...
        DragEdge: function (delta, e, edgeRestoreData, objectsMarkedToDrag){
            var site = null;
            if (objectsMarkedToDrag.Contains$$T(e.get_Source())){
                if (!objectsMarkedToDrag.Contains$$T(e.get_Target()))
                    site = e.get_UnderlyingPolyline().get_HeadSite();
            }
            else
                site = e.get_UnderlyingPolyline().get_LastSite();
            if (site == null)
                Microsoft.Msagl.Drawing.GeometryGraphEditor.TranslateEdge(e, delta, edgeRestoreData);
            else
                Microsoft.Msagl.Drawing.GeometryGraphEditor.DragEdgeWithSite(delta, e, site);
        },
        ...
        TranslateEdge: function (e, delta, edgeRestoreData){
            if (edgeRestoreData.get_Curve() != null){
                e.set_Curve(edgeRestoreData.get_Curve().Clone());
                e.get_Curve().Translate(delta);
            }
            if (e.get_UnderlyingPolyline() != null)
                for (var s = e.get_UnderlyingPolyline().get_HeadSite(),s0 = edgeRestoreData.get_UnderlyingPolyline().get_HeadSite(); s != null; s = s.get_Next(), s0 = s0.get_Next())
                    s.set_Point(Microsoft.Msagl.Core.Geometry.Point.op_Addition(s0.get_Point(), delta));
            if (e.get_EdgeGeometry().get_SourceArrowhead() != null)
                e.get_EdgeGeometry().get_SourceArrowhead().set_TipPosition(Microsoft.Msagl.Core.Geometry.Point.op_Addition(edgeRestoreData.get_ArrowheadAtSourcePosition(), delta));
            if (e.get_EdgeGeometry().get_TargetArrowhead() != null)
                e.get_EdgeGeometry().get_TargetArrowhead().set_TipPosition(Microsoft.Msagl.Core.Geometry.Point.op_Addition(edgeRestoreData.get_ArrowheadAtTargetPosition(), delta));
            if (e.get_Label() != null)
                e.get_Label().set_Center(Microsoft.Msagl.Core.Geometry.Point.op_Addition(edgeRestoreData.get_LabelCenter(), delta));
        },
        CalculateOffsetsForMultiedges: function (node, nodeSeparation){
            ...
            var $it69 = Microsoft.Msagl.Drawing.GeometryGraphEditor.GetMultiEdges(node).GetEnumerator();
            while ($it69.MoveNext()){
                var multiedge = $it69.get_Current();
        ...
        CalculateMiddleOffsetsForMultiedge: function (multiedge, node, offsetsInsideOfMultiedge, nodeSeparation){
            ...
            var i = 0;
            var $it70 = middleAngles.GetEnumerator();
            while ($it70.MoveNext()){
                var v = $it70.get_Current();
    ...
    definition: {
        ...
        DragObjectsForRectilinearCase: function (delta){
            var $it47 = System.Linq.Enumerable.Where$1$$IEnumerable$1$$Func$2(Microsoft.Msagl.Core.Layout.GeometryObject.ctor, this.objectsToDrag, $CreateAnonymousDelegate(this, function (n){
                return Is(n, Microsoft.Msagl.Core.Layout.Node.ctor);
            })).GetEnumerator();
            while ($it47.MoveNext()){
                var node = $it47.get_Current();
            ...
            labelPlacer.Run();
            var $it48 = this.get_Graph().get_Edges().GetEnumerator();
            while ($it48.MoveNext()){
                var e = $it48.get_Current();
                this.UpdateGraphBoundingBoxWithCheck$$GeometryObject(e);
            }
            var $it49 = this.get_Graph().get_Nodes().GetEnumerator();
            while ($it49.MoveNext()){
                var n = $it49.get_Current();
        ...
        PropagateChangesToClusterParents: function (){
            ...
            var $it51 = this.objectsToDrag.GetEnumerator();
            while ($it51.MoveNext()){
                var n = $it51.get_Current();
                var node = As(n, Microsoft.Msagl.Core.Layout.Node.ctor);
                if (node == null)
                    continue;
                var $it52 = node.get_AllClusterAncestors().GetEnumerator();
                while ($it52.MoveNext()){
            ...
            if (System.Linq.Enumerable.Any$1$$IEnumerable$1(Microsoft.Msagl.Core.Layout.Cluster.ctor, touchedClusters)){
                var $it53 = this.graph.get_RootCluster().AllClustersDepthFirstExcludingSelf().GetEnumerator();
                while ($it53.MoveNext()){
        ...
        DragWithSplinesOrBundles: function (delta){
            var $it54 = this.objectsToDrag.GetEnumerator();
            while ($it54.MoveNext()){
                var geomObj = $it54.get_Current();
                var node = As(geomObj, Microsoft.Msagl.Core.Layout.Node.ctor);
                if (node != null)
                    node.set_Center(Microsoft.Msagl.Core.Geometry.Point.op_Addition(node.get_Center(), delta));
            }
        ...
        DragEdgesAsStraighLines: function (delta){
            var $it55 = this.edgesDraggedWithSource.GetEnumerator();
            while ($it55.MoveNext()){
                var edge = $it55.get_Current();
                Microsoft.Msagl.Drawing.GeometryGraphEditor.DragEdgeAsStraightLine(delta, edge);
            }
            var $it56 = this.edgesDraggedWithTarget.GetEnumerator();
            while ($it56.MoveNext()){
                var edge = $it56.get_Current();
                Microsoft.Msagl.Drawing.GeometryGraphEditor.DragEdgeAsStraightLine(delta, edge);
            }
        ...
        UpdateGraphBoundingBoxWithCheck: function (){
            var $it57 = this.graph.get_Nodes().GetEnumerator();
            while ($it57.MoveNext()){
                var node = $it57.get_Current();
                this.UpdateGraphBoundingBoxWithCheck$$GeometryObject(node);
            }
            var $it58 = this.graph.get_Edges().GetEnumerator();
            while ($it58.MoveNext()){
                var edge = $it58.get_Current();
        ...
        GetUpdatedRegionAndCleanUpAffectedObjects: function (){
            var rect = Microsoft.Msagl.Core.Geometry.Rectangle.CreateAnEmptyBox();
            var affectedObjectList = new System.Collections.Generic.List$1.ctor$$IEnumerable$1(Microsoft.Msagl.Drawing.IViewerObject.ctor, this.get_CurrentUndoAction().get_AffectedObjects());
            var $it59 = affectedObjectList.GetEnumerator();
            while ($it59.MoveNext()){
                var ivObj = $it59.get_Current();
                var inode = As(ivObj, Microsoft.Msagl.Drawing.IViewerNode.ctor);
                if (inode == null)
                    continue;
                var node = Cast(inode.get_DrawingObject().get_GeometryObject(), Microsoft.Msagl.Core.Layout.Node.ctor);
                var nrd = Cast(this.get_CurrentUndoAction().GetRestoreData(node), Microsoft.Msagl.Prototype.LayoutEditing.NodeRestoreData.ctor);
                var oldBoundingBox = nrd.get_BoundaryCurve().get_BoundingBox();
                if (!oldBoundingBox.Equals$$Rectangle(node.get_BoundingBox())){
                    rect.Add$$Rectangle(node.get_BoundingBox());
                    rect.Add$$Rectangle(oldBoundingBox);
                }
                else
                    this.get_CurrentUndoAction().RemoveAffectedObject(ivObj);
            }
            var $it60 = System.Linq.Enumerable.Concat$1(Microsoft.Msagl.Core.Layout.Edge.ctor, this.edgesDraggedWithSource, this.edgesDraggedWithTarget).GetEnumerator();
            while ($it60.MoveNext()){
                var e = $it60.get_Current();
                rect.Add$$Rectangle(e.get_BoundingBox());
            }
            rect.Pad$$Double(this.layoutSettings.get_EdgeRoutingSettings().get_Padding());
            return rect;
        },
        ...
        CalculateDragSets: function (markedObjects){
            ...
            var $it61 = markedObjects.GetEnumerator();
            while ($it61.MoveNext()){
                var geometryObject = $it61.get_Current();
        ...
        RemoveClusterSuccessorsFromObjectsToDrag: function (){
            ...
            var $it62 = System.Linq.Enumerable.OfType$1(Microsoft.Msagl.Core.Layout.Node.ctor, this.objectsToDrag).GetEnumerator();
            while ($it62.MoveNext()){
                var node = $it62.get_Current();
            ...
            var $it63 = listToRemove.GetEnumerator();
            while ($it63.MoveNext()){
                var node = $it63.get_Current();
        ...
        CalculateDragSetsForEdges: function (){
            var $it64 = this.objectsToDrag.Clone().GetEnumerator();
            while ($it64.MoveNext()){
                var geomObj = $it64.get_Current();
                var node = As(geomObj, Microsoft.Msagl.Core.Layout.Node.ctor);
                if (node != null)
        ...
        AssignEdgesOfNodeToEdgeDragSets: function (node){
            var $it65 = node.get_SelfEdges().GetEnumerator();
            while ($it65.MoveNext()){
                var edge = $it65.get_Current();
                this.objectsToDrag.Insert(edge);
            }
            var $it66 = node.get_InEdges().GetEnumerator();
            while ($it66.MoveNext()){
                var edge = $it66.get_Current();
            ...
            var $it67 = node.get_OutEdges().GetEnumerator();
            while ($it67.MoveNext()){
                var edge = $it67.get_Current();
            ...
            var cl = As(node, Microsoft.Msagl.Core.Layout.Cluster.ctor);
            if (cl != null){
                var $it68 = cl.AllSuccessorsWidthFirst().GetEnumerator();
                while ($it68.MoveNext()){
                    var n = $it68.get_Current();
        ...
        FitGraphBoundingBox: function (affectedEntity, geometryGraph){
            if (geometryGraph != null){
                ...
                var $it74 = geometryGraph.get_Nodes().GetEnumerator();
                while ($it74.MoveNext()){
                    var n = $it74.get_Current();
                    r = n.get_BoundingBox();
                    break;
                }
                var $it75 = geometryGraph.get_Nodes().GetEnumerator();
                while ($it75.MoveNext()){
                    var n = $it75.get_Current();
                    r.Add$$Rectangle(n.get_BoundingBox());
                }
                var $it76 = geometryGraph.get_Edges().GetEnumerator();
                while ($it76.MoveNext()){
                    var e = $it76.get_Current();
        ...
        PrepareForClusterCollapseChange: function (changedClusters){
            ...
            var $it77 = changedClusters.GetEnumerator();
            while ($it77.MoveNext()){
                var iCluster = $it77.get_Current();
...
var Microsoft$Msagl$Drawing$ObjectDragUndoRedoAction = {
    ...
    definition: {
        ...
        Undo: function (){
            ...
            var $it78 = restDictionary.GetEnumerator();
            while ($it78.MoveNext()){
                var kv = $it78.get_Current();
        ...
        Redo: function (){
            ...
            var $it79 = dict.GetEnumerator();
            while ($it79.MoveNext()){
                var restoreData = $it79.get_Current();
...
var Microsoft$Msagl$Drawing$Node = {
    ...
    definition: {
        ...
        get_Edges: function (){
            var $yield = [];
            var $it80 = this.get_InEdges().GetEnumerator();
            while ($it80.MoveNext()){
                var e = $it80.get_Current();
                $yield.push(e);
            }
            var $it81 = this.get_OutEdges().GetEnumerator();
            while ($it81.MoveNext()){
                var e = $it81.get_Current();
                $yield.push(e);
            }
            var $it82 = this.get_SelfEdges().GetEnumerator();
            while ($it82.MoveNext()){
                var e = $it82.get_Current();
                $yield.push(e);
            }
            return $yield;
        },
        ...
        set_IsVisible: function (value){
            ...
            if (!value){
                var $it83 = this.get_Edges().GetEnumerator();
                while ($it83.MoveNext()){
                    var e = $it83.get_Current();
...
var Microsoft$Msagl$Drawing$PhyloTree = {
    ...
    definition: {
        ...
        get_Leaves: function (){
            var $yield = [];
            var $it84 = this.get_Nodes().GetEnumerator();
            while ($it84.MoveNext()){
                var node = $it84.get_Current();
...
var Microsoft$Msagl$Drawing$Subgraph = {
    ...
    definition: {
        ...
        AllSubgraphsDepthFirst: function (){
            var $yield = [];
            var $it85 = this.subgraphs.GetEnumerator();
            while ($it85.MoveNext()){
                var c = $it85.get_Current();
                var $it86 = c.AllSubgraphsDepthFirst().GetEnumerator();
                while ($it86.MoveNext()){
                    var d = $it86.get_Current();
                    $yield.push(d);
                }
            }
            $yield.push(this);
        ...
        AllSubgraphsDepthFirstExcludingSelf: function (){
            var $yield = [];
            var $it87 = this.subgraphs.GetEnumerator();
            while ($it87.MoveNext()){
                var c = $it87.get_Current();
                var $it88 = c.AllSubgraphsDepthFirst().GetEnumerator();
                while ($it88.MoveNext()){
                    var d = $it88.get_Current();
                    $yield.push(d);
                }
            }
            return $yield;
        ...
        AllSubgraphsWidthFirstExcludingSelf: function (){
            var $yield = [];
            var $it89 = this.subgraphs.GetEnumerator();
            while ($it89.MoveNext()){
                var c = $it89.get_Current();
                $yield.push(c);
                var $it90 = c.AllSubgraphsWidthFirstExcludingSelf().GetEnumerator();
                while ($it90.MoveNext()){
                    var d = $it90.get_Current();
                    $yield.push(d);
                }
            }
            return $yield;
...
var Microsoft$Msagl$Drawing$SvgGraphWriter = {
        ...
        Write$$Graph$$String$$Func$2$String$String$$Func$2$String$String$$Int32: function (graph, outputFile, nodeSanitizer, attrSanitizer, precision){
            ...
            try{
                var writer = (function (){
                    ...
                    $v17.set_Precision(precision);
                    $v17.set_NodeSanitizer((nodeSanitizer != null ? nodeSanitizer : (function (t){
                        return t;
                    })));
                    $v17.set_AttrSanitizer((attrSanitizer != null ? attrSanitizer : (function (t){
                        return t;
                    })));
                    return $v17;
                })();
    ...
    definition: {
        ...
        Write: function (){
            ...
            try{
                this.graph.get_GeometryGraph().Transform(matrix);
                this.Open();
                Microsoft.Msagl.Drawing.SvgGraphWriter.WriteGraphAttr(this.graph.get_Attr());
                this.WriteLabel(this.graph.get_Label());
                this.WriteEdges();
                this.WriteNodes();
                this.Close();
        ...
        WriteLabel: function (label){
            ...
            this.WriteAttribute("fill", Microsoft.Msagl.Drawing.SvgGraphWriter.MsaglColorToSvgColor(label.get_FontColor()));
        ...
        WriteEdges: function (){
            ...
            var $it91 = this.graph.get_Edges().GetEnumerator();
            while ($it91.MoveNext()){
                var edge = $it91.get_Current();
                this.WriteEdge(edge);
            }
        },
        WriteEdge: function (edge){
        ...
        DrawArrowPolygon: function (attr, points){
            ...
            var edgeAttr = As(attr, Microsoft.Msagl.Drawing.EdgeAttr.ctor);
            if (edgeAttr != null){
                this.WriteAttribute("fill", Microsoft.Msagl.Drawing.SvgGraphWriter.MsaglColorToSvgColor(attr.get_Color()));
        ...
        WriteNodes: function (){
            ...
            var $it92 = this.graph.get_Nodes().GetEnumerator();
            while ($it92.MoveNext()){
                var node = $it92.get_Current();
                this.WriteNode(node);
            }
        ...
        WriteFromMsaglCurve: function (node){
            ...
            if (c != null)
                ...
                if (ellipse != null)
                    ...
                    if (poly != null)
                        this.WritePolyline(poly, attr);
                    else
                        throw $CreateException(new System.NotImplementedException.ctor(), new Error());
                }
            }
        },
        WritePolyline: function (poly, attr){
            throw $CreateException(new System.NotImplementedException.ctor(), new Error());
        },
        ...
        WriteStroke: function (attr){
            this.WriteAttribute("stroke", Microsoft.Msagl.Drawing.SvgGraphWriter.MsaglColorToSvgColor(attr.get_Color()));
        ...
        CurveStringTokens: function (iCurve){
            ...
            if (curve != null){
                var $it93 = curve.get_Segments().GetEnumerator();
                while ($it93.MoveNext()){
                ...
                if (lineSeg != null){
                    ...
                    if (cubic != null){
                        ...
                        var poly = As(iCurve, Microsoft.Msagl.Core.Geometry.Curves.Polyline.ctor);
                        if (poly != null){
                            var $it94 = System.Linq.Enumerable.Skip$1(Microsoft.Msagl.Core.Geometry.Point.ctor, poly, 1).GetEnumerator();
                            while ($it94.MoveNext()){
                                var p = $it94.get_Current();
                                $yield.push("L");
                            ...
                            if (roundedRect != null){
                                var $it95 = roundedRect.get_Curve().get_Segments().GetEnumerator();
                                while ($it95.MoveNext()){
                                    var segment = $it95.get_Current();
                                    $yield.push(this.SegmentString(segment));
                                }
                            }
                            else {
        ...
        WriteFill: function (attr){
            ...
            if (color.get_A() == 0 && !System.Linq.Enumerable.Contains$1$$IEnumerable$1$$TSource(Microsoft.Msagl.Drawing.Style.ctor, attr.get_Styles(), Microsoft.Msagl.Drawing.Style.Filled)){
                ...
                this.WriteAttribute("fill", Microsoft.Msagl.Drawing.SvgGraphWriter.MsaglColorToSvgColor(color));
...
var Microsoft$Msagl$Drawing$VerticalConstraintsForLayeredLayout = {
    ...
    definition: {
        ...
        UnpinNodeFromMaxLayer: function (node){
            this._maxLayerOfDrawingGraph.Remove(node);
        },
        UnpinNodeFromMinLayer: function (node){
            this._minLayerOfDrawingGraph.Remove(node);
        },
        Clear: function (){
